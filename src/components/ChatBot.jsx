...
const ChatBot = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-30 right-8 md:bottom-[7.5rem] md:right-8 z-50">
        {/* Chat Toggle Button */}
        <button
          ref={buttonRef}
          onClick={() => setIsOpen(!isOpen)}
          className="
            w-16 h-16 md:w-16 md:h-16 rounded-full
        ...
        {isOpen && (
          <div
            ...
            className="
              fixed 
              bottom-24 right-6
              w-[calc(100vw-3rem)] h-[calc(100vh-15rem)]
              max-w-md
              md:absolute md:w-96 md:h-[500px]
          ...
          >
            {/* Header Section */}
            <div className="p-4 md:p-6 md:pb-4 border-b-2 bg-black border-slate-500 flex-shrink-0">
            ...
            <div
              ...
              className="flex-1 overflow-y-auto p-3 md:p-4 space-y-3 md:space-y-4 overscroll-contain"
            >
              {messages.length === 0 ? (
                <div className="text-center text-slate-400 py-8">
                  <p className="text-xs md:text-sm">
                    Welcome! Ask me anything about astronomy, space technology,
                    or SAST.
                  </p>
                </div>
              ) : (
                messages.map((message, index) => (
                  ...
                  >
                    <div
                      className={`
                        max-w-[85%] md:max-w-[80%] px-3 md:px-4 py-2 md:py-3 rounded-2xl text-xs md:text-sm
                        ${
                          message.role === "user"
              ...
              {isLoading && (
                <div className="flex justify-start">
                  <div className="bg-slate-700 text-slate-100 rounded-2xl rounded-bl-md px-3 md:px-4 py-2 md:py-3">
            ...
            {/* Input Area */}
            <div className="p-3 md:p-4 border-t border-slate-600 flex-shrink-0">
              <form onSubmit={handleSendMessage} className="flex gap-2">
                <input
                  ...
                  disabled={isLoading}
                  className="
                    flex-1 px-3 md:px-4 py-2 md:py-3 rounded-xl
